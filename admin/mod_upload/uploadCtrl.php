<?php 
    ...
    //     $file=$_FILES['urlfile'];
    //     var_dump($file);
    //     //tentukan lokasi pemyimpanan file
    ...
    function pesan($alert){	
        ...
        echo '</script>';
        echo '<meta http-equiv="refresh" content="0; url=http://localhost/latihan_webphp1/latihan_webphpNw/admin/home.php?modul=mod_upload">';	
    }
?>